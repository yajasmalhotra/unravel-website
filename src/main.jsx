...
function App() {
  ...
  return <div className="site">
    ...
    <section className="approach" id="resonance"><Ghost>THREAD</Ghost><Reveal className="approach__reveal"><div className="section-kicker light"><span className="spin-slow">✦</span> &nbsp; 02 — HOW WE WORK</div><div className="approach__cards"><article className="approach__card"><i /><h3>Individual Therapy</h3><p>One-to-one support for anxiety, burnout, identity, relationships, grief, and the patterns that keep taking more from you than they give. We make sense of what you are carrying and work toward choices that feel steadier, clearer, and more like your own.</p></article><article className="approach__card"><i /><h3>EMDR Therapy</h3><p>EMDR can help process distressing experiences that still feel present in your body, emotions, or relationships. The work moves at your pace, with preparation and grounding built in so change does not require reliving everything alone.</p></article><article className="approach__card"><i /><h3>Sex and Couples Therapy</h3><p>A collaborative space to talk honestly about intimacy, desire, communication, conflict, trust, and the cultural messages shaping your relationship. The goal is not to assign blame, but to understand the pattern between you and build a more connected way forward.</p></article><article className="approach__card"><i /><h3>Affordable Low-Cost Therapy</h3><p>Lower-cost counselling options can make consistent support more accessible when finances are part of the stress. Reach out to ask about current availability, fees, and whether an affordable therapy option may be a fit for your needs.</p></article></div><p className="approach__note">All sessions are offered virtually to clients across British Columbia, with care shaped around your goals, pace, and lived experience.</p></Reveal></section>
    ...
    <section className="about" id="about"><Ghost align="right">SELF</Ghost><Reveal className="about__reveal"><div className="section-kicker"><span className="spin-slow">✦</span> &nbsp; 05 — About me</div><div className="about__grid"><div className="portrait"><div className="portrait__image"><picture><source type="image/avif" srcSet="/therapist-headshot-480.avif 480w, /therapist-headshot-840.avif 840w" sizes="(max-width: 520px) calc(100vw - 48px), 420px" /><source type="image/webp" srcSet="/therapist-headshot-480.webp 480w, /therapist-headshot-840.webp 840w" sizes="(max-width: 520px) calc(100vw - 48px), 420px" /><img src="/therapist-headshot.png" width="1122" height="1402" loading="lazy" decoding="async" alt="Theekshitha Vadladi, South Asian counsellor" /></picture></div><h2>Theekshitha Vadladi</h2><p>she/her</p></div><div className="about__copy"><h2 style={{ textAlign: 'center' }}><span style={{ fontSize: 'calc(1em - 3pt)' }}>You're allowed to want your own life.</span></h2><p>For a lot of people, that sentence lands somewhere between relief and betrayal. Both make sense.</p><p>As a South Asian woman and a first-generation immigrant, I understand the pressure to be impressive, grateful, available, and okay. You will not need to explain why family love and family obligation can feel tangled, or why success can come with guilt. I bring peer-to-peer relatability alongside clinical training in ACT, EMDR, and somatic and relational approaches.</p><p>Our work is about more than insight. It is about reclaiming your energy, trusting your own voice, and making choices that belong to you.</p></div></div></Reveal></section>
