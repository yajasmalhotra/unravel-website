...
function Direction03() {
  ...
  return <div className="site">
    ...
    <footer><span>Unravel Counselling</span><span>Virtual counselling across British Columbia · {EMAIL}</span></footer>
  </div>;
}
